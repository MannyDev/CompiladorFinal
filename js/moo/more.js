...
// Load this file's selection again by visiting: http://mootools.net/more/52be0a580960685c04a9f09bdf805657 
// Or build this file again with packager using: packager build More/Events.Pseudos More/Array.Extras More/Date More/Date.Extras More/Number.Format More/Object.Extras More/String.Extras More/Fx.Accordion More/Fx.Move More/Fx.Reveal More/Fx.Scroll More/Fx.Slide More/Fx.SmoothScroll More/Fx.Sort More/Drag.Move More/Slider More/Sortables More/Request.JSONP More/Request.Queue More/Assets More/Group More/Scroller More/Tips More/Spinner
/*
---
copyrights:
...
["Request","Fx"].each(function(c){if(this[c]){this[c].implement(Events.prototype);}});})();(function(a){Array.implement({min:function(){return Math.min.apply(null,this);
...
g.each(function(h,j){h.addEvent(e,function(){if(!c[j]){f--;}c[j]=arguments;if(!f){d.call(b,g,h,c);f=a;c=new Array(a);}});});}});})();var Scroller=new Class({Implements:[Events,Options],options:{area:20,velocity:1,onChange:function(a,b){this.element.scrollTo(a,b);
